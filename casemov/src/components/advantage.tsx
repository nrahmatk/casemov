...
export default function AdvantagesSection() {
  ...
  // Memoize advantages data to prevent recreation on each render
  ...
  const underlineVariants = {
    hidden: { width: 0 },
    visible: { width: 80, transition: { delay: 0.3, duration: 0.6 } },
  };
  ...
  return (
    <section ref={ref} className="bg-gradient-to-b from-white to-gray-100 py-20 rounded-2xl">
      {inView && (
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-between lg:px-8">
            {/* Left side SVG image - lazy loaded */}
            <motion.div
